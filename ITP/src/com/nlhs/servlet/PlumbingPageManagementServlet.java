 ...
 */
@WebServlet("/PlumbingPageManagementServlet")
public class PlumbingPageManagementServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PlumbingPageManagementServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String message = isi.PlumbingPageItems(product1, product2, product3, product4, product5, product6);
