...
/**
 * Servlet implementation class UpdateSupProServlet
 */
@WebServlet("/UpdateSupProServlet")
public class UpdateSupProServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateSupProServlet() {
        super();
