 ...
 */
@WebServlet("/HomePageManagementServlet")
public class HomePageManagementServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public HomePageManagementServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String message = isi.HomePageItems(product1, product2, product3, product4, product5, product6);
