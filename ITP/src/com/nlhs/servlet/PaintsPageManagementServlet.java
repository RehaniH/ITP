 ...
 */
@WebServlet("/PaintsPageManagementServlet")
public class PaintsPageManagementServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PaintsPageManagementServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String message = isi.PaintsPageItems(product1, product2, product3, product4, product5, product6);
