...
try
{
    ...
    String query = "select * from cart ";          //Fetching data from table
    ...
    document.add(new Paragraph("----------------------------------------------- Purchased Details History Report --------------------------------------\n\n"));
    ...
    while(rs.next())
    {
        ...
        document.add(new Paragraph("Customer Email ::"+rs.getString(1)+"\nItem ID ::"+rs.getString(2)+"\nProduct Name ::"+rs.getString(3)+"\nQuantity ::"+rs.getString(4)+"\nProduct value ::"+rs.getString(6)+"\n\n"));
    }
